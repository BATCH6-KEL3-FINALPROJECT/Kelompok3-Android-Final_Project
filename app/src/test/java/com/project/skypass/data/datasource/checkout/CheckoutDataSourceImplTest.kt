...
class CheckoutDataSourceImplTest {
    ...
    fun createBooking() =
        runBlocking {
            ...
            val passengerData =
                PassengerData("dateOfBirth", "departureSeats", "email", "firstName", "issuingCountry", "lastName", "nationality", "passengerType", "passportNo", "phoneNumber", "returnSeats", "title", "validUntil")
            ...
            val bookingResult =
                BookingResult("bookingCode", "bookingDate", "bookingId", "createdAt", "flightId", true, 1, "paymentId", "status", "totalPrice", "updatedAt", "userId")
            val returnBookingResult =
                ReturnBookingResult("bookingCode", "bookingDate", "bookingId", "createdAt", "flightId", true, 1, "paymentId", "status", "totalPrice", "updatedAt", "userId")
    ...
    fun getBookingData() =
        runBlocking {
            ...
            val flightDescription =
                FlightDescription(
                    details = listOf(detail),
                )

            val departingAirport =
                DepartingAirport(
                    city = "departing_city",
                )
            ...
            val getBookingDataItemResponse =
                GetBookingDataItemResponse(
                    adultPrice = 10,
                    adultTotalPrice = 20,
                    babyTotalPrice = 30,
            ...
            val data =
                com.project.skypass.data.source.network.model.booking.Data(
