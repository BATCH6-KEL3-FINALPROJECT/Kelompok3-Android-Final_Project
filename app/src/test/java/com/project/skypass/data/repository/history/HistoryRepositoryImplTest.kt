...
class HistoryRepositoryImplTest {
    ...
    @Test
    fun getHistory_success() = runBlocking {
        val token = "token"
    ...
    @Test
    fun getDetailHistory_success() = runBlocking {
        val token = "token"
        val id = "id"
        ...
        val detailHistoryResponse = DetailHistoryResponse(
            ...
            DetailHistoryItemResponse(
                ...
                bookingDate = "2022-01-01",
                bookingId = "booking_id",
                flight = com.project.skypass.data.source.network.model.history.detailhistory.Flight(
                    airline = Airline(
                        "airline_code",
                        "airline_id",
                        "airline_name",
                ...
                tickets = listOf(
                    com.project.skypass.data.source.network.model.history.detailhistory.Ticket(
                        passenger = com.project.skypass.data.source.network.model.history.detailhistory.Passenger(
                            firstName = "John",
                            lastName = "Doe",
                            passengerId = "passenger_id",
