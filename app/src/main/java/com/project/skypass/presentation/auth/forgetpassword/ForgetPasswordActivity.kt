            ...
            result.proceedWhen(
                doOnSuccess = {
                    ...
                    StyleableToast.makeText(this,
                        "Request telah berhasil dikirimkan ke email yang anda masukkan", R.style.ToastSuccess).show()
                },
                doOnLoading = {
                ...
                doOnError = {
                    ...
                    binding.btnSendLinkResetPassword.isEnabled = false
                    StyleableToast.makeText(this,
                        "Request gagal dikirimkan ke email yang anda masukkan", R.style.ToastError).show()
                }
            )
        }
    }
