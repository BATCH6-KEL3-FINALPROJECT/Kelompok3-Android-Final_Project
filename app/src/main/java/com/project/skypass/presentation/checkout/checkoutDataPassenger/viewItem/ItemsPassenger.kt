...
import com.project.skypass.databinding.ItemChecekoutDataPassengerBinding
...
class DataItem(private val data: String, private val onItemClick: (item: String) -> Unit) :
    BindableItem<ItemChecekoutDataPassengerBinding>() {


    override fun bind(viewBinding: ItemChecekoutDataPassengerBinding, position: Int) {
    ...
    override fun getLayout(): Int = R.layout.item_checekout_data_passenger

    override fun initializeViewBinding(view: View): ItemChecekoutDataPassengerBinding =
        ItemChecekoutDataPassengerBinding.bind(view)
}
