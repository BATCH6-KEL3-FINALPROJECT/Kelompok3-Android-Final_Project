...
class DataItem(private var data: PassengersData, private val onItemClick: (item: PassengersData) -> Unit) :
    ...
    override fun bind(
        viewBinding: ItemCheckoutDataPassengerBinding,
        position: Int,
    ) {
        setupTitleDropdown(viewBinding)
        viewBinding.etDateBorn.onFocusChangeListener =
    ...
    override fun initializeViewBinding(view: View): ItemCheckoutDataPassengerBinding = ItemCheckoutDataPassengerBinding.bind(view)
}
...
class HeaderItem(private val title: String, private val onHeaderClick: (item: String) -> Unit) :
    ...
    override fun bind(
        viewBinding: ItemCheckoutHeaderPassengerBinding,
        position: Int,
    ) {
    ...
    override fun initializeViewBinding(view: View): ItemCheckoutHeaderPassengerBinding = ItemCheckoutHeaderPassengerBinding.bind(view)
}
